...
class AbstractTest(TestCase):
    ...
    def patch(self, url, body={}, response_status_code=201, with_basic_auth=True):
        return self._do_call(body, self.client.patch, response_status_code, url, with_basic_auth)
